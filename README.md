...
Build and start the service locally with Docker Compose:
...
Apple-silicon Macs running macOS 26 can run the full ISACAPI, PostgreSQL, and Redis stack with Apple `container` 1.1.0 or newer:
