  ...
  >
    <div v-if="account" class="space-y-4">
      ...
      <OAuthAuthorizationFlow
        ...
        :show-project-id="isGemini && geminiOAuthType !== 'ai_studio'"
...
const handleGenerateUrl = async () => {
  ...
  if (isOpenAILike.value) {
    ...
    const existingProjectId = typeof creds.project_id === 'string' ? creds.project_id : undefined
    const projectId =
      geminiOAuthType.value !== 'ai_studio'
        ? oauthFlowRef.value?.projectId || existingProjectId
        : undefined
