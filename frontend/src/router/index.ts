/**
 * Vue Router configuration for ISACAPI frontend
...
const BACKEND_MODE_ALLOWED_PATHS = ['/login', '/pricing', '/key-usage', '/setup', '/payment/result', '/payment/airwallex', '/legal', '/status']
