export default {
  ...
  keys: {
    ...
    ccsClientSelect: {
      ...
      antigravityDesc: '使用此分组的 Antigravity 兼容路由',
      antigravityUnavailable: '当前 CC-Switch 不支持导入 Antigravity API 提供商。请改选其他客户端，或手动配置 Antigravity。',
      openclaw: 'OpenClaw',
      ...
      pi: 'Pi',
      piDesc: '生成 Pi models.json 提供商配置',
      piHint: '请将此配置合并到 ~/.pi/agent/models.json，然后刷新 CC-Switch 的 Pi 页面。',
      piCopy: '复制 models.json',
      piCopied: 'Pi 配置已复制',
      piDownload: '下载 models.json',
  ...
  profile: {
    ...
    superAdministratorProvider: '超级管理员 + 供号方',
    administrator: '普通管理员',
    administratorProvider: '管理员 + 供号方',
    provider: '供号方',
    user: '用户',
    username: '用户名',
    email: '邮箱',
