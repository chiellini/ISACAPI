export default {
  common: {
    ...
    contactSupport: '联系客服',
    contactAdmin: '联系管理员',
    contactAdminHint: '如需帮助，请加入 QQ 群：{qq}',
    recharge: '充值',
    rechargeContactHint: '当前未启用在线充值，请加入 QQ 群联系管理员。',
    apply: '应用',
    clear: '清除',
    creating: '创建中...',
    required: '必填',
  ...
  chat: {
    ...
    errQuota: '额度已用尽，请稍后再试。',
    errRate: '请求过于频繁，请稍后再试。',
    errTimeout: '请求超时，请重试。',
    errUnavailable: '聊天服务暂时不可用，请稍后再试。',
    errModel: '所选模型不可用或暂不支持。',
    errGeneric: '发生错误，请重试。',
  ...
  auth: {
    ...
    teamBusiness: {
      audience: '高校课题组 · 企业团队',
      title: '负责人可自行创建小组',
      description: '注册并登录后即可创建；成员保持独立账号，并可查看自己的课题组额度。',
      sharedBalance: '独立账号 · 共享余额',
      quotaControl: '月度额度 · 可见可控',
      corporateInvoice: '正规对公发票可申请',
      compliantIntegration: '合规软件信息集成服务可咨询',
      disclaimer: '具体开票资格、范围与集成方案，以客服确认及正式合同为准。',
    },
    processing: '处理中...',
    continue: '继续',
    rememberMe: '记住我',
