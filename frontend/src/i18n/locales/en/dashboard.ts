export default {
  ...
  keys: {
    ...
    ccsClientSelect: {
      ...
      antigravityDesc: 'Use the Antigravity-compatible route for this group',
      antigravityUnavailable: 'CC-Switch currently does not support importing Antigravity API providers. Use another client target, or configure Antigravity manually.',
      openclaw: 'OpenClaw',
      ...
      pi: 'Pi',
      piDesc: 'Prepare a Pi models.json provider configuration',
      piHint: 'Copy or download this provider into ~/.pi/agent/models.json, then refresh the Pi page in CC-Switch.',
      piCopy: 'Copy models.json',
      piCopied: 'Pi configuration copied',
      piDownload: 'Download models.json',
  ...
  profile: {
    ...
    superAdministratorProvider: 'Super Administrator + Provider',
    administrator: 'Administrator',
    administratorProvider: 'Administrator + Provider',
    provider: 'Provider',
    user: 'User',
    username: 'Username',
    email: 'Email',
