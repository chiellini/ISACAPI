export default {
    ...
    riskControl: {
      ...
      localSecurityRulesHint: 'JSON array. Built-in local rules remain enabled. A rule matches when an exact term appears, all terms in "all" appear, or any action appears together with any target. Rules are applied before billing, routing, and upstream calls.',
      localSecurityRulesInvalidJSON: 'Local security rules must be a valid JSON array.',
      localSecurityWhitelist: 'Local filter account whitelist',
      localSecurityWhitelistPlaceholder: 'One user ID per line, e.g.\n10001\n10002',
      localSecurityWhitelistHint: 'Whitelisted user IDs bypass the local political, reverse-engineering, and cyber keyword layer only. Upstream moderation, billing, routing, and other account controls are unchanged.',
      localSecurityWhitelistInvalid: 'Each whitelist entry must be a positive integer user ID.',
