export default {
    settings: {
      ...
      openaiFastPolicy: {
        ...
        modelWhitelist: 'Model whitelist',
        modelWhitelistHint: 'Leave empty to apply to all models. Supports exact match and wildcard prefix (e.g., gpt-5.6-sol*).',
        modelPatternPlaceholder: 'e.g., gpt-5.6-sol or gpt-5.6-sol*',
        addModelPattern: 'Add model pattern',
        fallbackAction: 'Fallback action',
        fallbackActionHint: 'Action for models not matching the whitelist.',
        fallbackErrorMessagePlaceholder: 'Custom error message when non-whitelisted models are blocked'
