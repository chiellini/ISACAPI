export default {
    accounts: {
      ...
      openai: {
        ...
        hermesUserAgent: 'Enable Hermes Agent User-Agent',
        hermesUserAgentDesc:
          'Only applies to OpenAI API Key accounts. Uses hermes-agent/1.0 as the request identity to avoid upstream WAF blocks against the OpenAI SDK default User-Agent.',
