export default {
  common: {
    ...
    contactAdminHint: 'For help, join the QQ group: {qq}',
    recharge: 'Recharge',
    rechargeContactHint: 'Online recharge is currently unavailable. Please join the QQ group to contact an administrator.',
    apply: 'Apply',
    clear: 'Clear',
    creating: 'Creating...',
    required: 'Required',
  ...
  chat: {
    ...
    noImage: 'No image was generated.',
    errBalance: 'Insufficient balance. Please recharge and try again.',
    errQuota: 'Your quota has been exhausted. Please try again later.',
    errRate: 'Too many requests. Please try again shortly.',
    errTimeout: 'The request timed out. Please try again.',
    errUnavailable: 'Chat is temporarily unavailable. Please try again later.',
    errModel: 'The selected model is unavailable or unsupported.',
