export default {
  ...
  setup: {
    title: 'ISACAPI Setup',
    description: 'Configure your ISACAPI instance',
    database: {
  ...
  common: {
    ...
    recharge: 'Recharge',
    rechargeContactHint: 'To top up your balance, please contact the admin via:',
    add: 'Add',
  ...
  chat: {
    model: 'Model',
    newChat: 'New chat',
    empty: 'Start chatting — pick a model and send a message.',
  ...
  admin: {
    ...
    accounts: {
      ...
      oauth: {
        ...
        // Gemini specific
	        gemini: {
	          ...
	          generateAuthUrl: 'Generate Auth URL',
	          projectIdLabel: 'Project ID (required)',
	          projectIdPlaceholder: 'e.g. my-gcp-project or cloud-ai-companion-xxxxx',
	          projectIdHint:
	            'Required for Code Assist and Google One OAuth. Create or select a Google Cloud project, enable Gemini for Google Cloud API, then paste the Project ID.',
          ...
          confirmRedirectUri:
            'I have configured this Redirect URI in the Google OAuth client (must match exactly)',
	          ...
	          missingProjectId: 'Project ID is required for Code Assist / Google One OAuth. Create or select a Google Cloud project, enable Gemini for Google Cloud API, make sure this Google account has access, then paste the Project ID before generating the auth URL.',
          ...
          needsProjectId: 'Built-in OAuth (Code Assist / Google One)',
          needsProjectIdDesc: 'Requires Project ID with Gemini for Google Cloud API enabled',
      ...
      gemini: {
        ...
        oauthType: {
          ...
          googleOneDesc: 'Personal Google account, requires a Google Cloud Project ID',
          codeAssistDesc: 'Enterprise-grade, requires a Google Cloud Project ID',
        ...
        quotaPolicy: {
          ...
          rows: {
            googleOne: {
              ...
              limitsPlus: 'Shared pool: 1200 RPD / 90 RPM',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for ISACAPI end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for ISACAPI end-user login',
      ...
      site: {
        ...
        siteName: 'Site Name',
        siteNamePlaceholder: 'ISACAPI',
        siteNameHint: 'Displayed in emails and page titles',
        siteSubtitle: 'Site Subtitle',
        siteSubtitlePlaceholder: 'AI API Service Platform',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 Welcome to ISACAPI',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">ISACAPI is a powerful AI service gateway platform that helps you easily manage and distribute AI services.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li>🔗 <b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li>🔑 <b>Key Distribution</b> - Generate independent API Keys for users</li><li>💰 <b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups are the core concept of ISACAPI, like a "service package":</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 Each group can contain multiple upstream accounts</li><li>💰 Each group has independent billing multiplier</li><li>👥 Can be set as public or exclusive</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Example:</b> You can create "VIP Premium" (high rate) and "Free Trial" (low rate) groups</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to ISACAPI',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the ISACAPI AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
