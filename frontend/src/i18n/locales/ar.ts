...
export default {
  ...
  auth: {
    ...en.auth,
    teamBusiness: {
      audience: 'الجامعات ومجموعات البحث · فرق الشركات',
      title: 'يمكن للمسؤول إنشاء مجموعته',
      description:
        'بعد التسجيل وتسجيل الدخول، يمكن إنشاء مجموعة. يحتفظ الأعضاء بحسابات مستقلة ويمكنهم رؤية مخصصاتهم ضمن المجموعة.',
      sharedBalance: 'حسابات مستقلة · رصيد مشترك',
      quotaControl: 'مخصصات شهرية مرئية وقابلة للإدارة',
      corporateInvoice: 'إمكانية طلب فواتير رسمية للشركات',
      compliantIntegration: 'استشارة تكامل معلومات برمجية متوافق',
      disclaimer: 'تخضع أهلية الفوترة ونطاقها وخدمات التكامل للتأكيد والعقد الرسمي.'
    }
  },
  ...
  home: {
    ...
    teams: {
      eyebrow: 'مجموعات بحثية · فرق شركات',
      title: 'حساب مسؤول واحد لدعم مجموعة بحثية أو فريق شركة بالكامل',
      description: 'يمكن للمسؤول التسجيل وإنشاء مجموعته وإدارة الرصيد المشترك والحصة الشهرية لكل عضو. يحتفظ الأعضاء بحساباتهم ومفاتيح API المستقلة، ويمكنهم رؤية حصة المجموعة والاستخدام والرصيد الشخصي في لوحتهم.',
      primaryAction: 'سجّل وأنشئ مجموعة',
      manageAction: 'إنشاء المجموعة أو إدارتها',
      loginAction: 'سجّل الدخول لعرض مجموعتك',
      features: {
        sharedBalance: {
          title: 'رصيد مشترك بتمويل مركزي',
          description: 'يموّل رصيد المسؤول فقط الطلبات المؤهلة للدفع حسب الاستخدام، ويدفع الطلب كاملا. لا تستخدم الاشتراكات الرصيد المشترك؛ وعند عدم كفاية المخصص أو رصيد المسؤول يتحول الطلب إلى رصيد العضو.'
        },
        independentAccounts: {
          title: 'حسابات مستقلة للأعضاء',
          description: 'يحتفظ كل عضو بتسجيل الدخول ومفاتيح API الخاصة به، ولا يحتاج المسؤول إلى جمع المفاتيح الخاصة أو التحكم بها.'
        },
        visibleQuota: {
          title: 'حصة شهرية ظاهرة للعضو',
          description: 'يرى العضو حد المجموعة الشهري والمستخدم والمتبقي، مع استمرار إتاحة الشحن الشخصي وصفحات الاستخدام.'
        },
        billingTrace: {
          title: 'سجلات واضحة للاستخدام والدفع',
          description: 'ينسب الاستخدام إلى العضو الذي أجرى الطلب، بينما تسجل الفوترة جهة الدفع الفعلية لتقارير تمويل المجموعة.'
        }
      },
      business: {
        badge: 'دعم مشتريات المؤسسات',
        title: 'دعم الشراء والتسليم للجامعات والشركات',
        description: 'مناسب للمجموعات البحثية والمختبرات وفرق الشركات التي تحتاج إلى شراء مركزي وحدود ميزانية واضحة وتكامل مستمر للذكاء الاصطناعي.',
        invoiceTitle: 'فواتير رسمية للشركات',
        invoiceDescription: 'تؤكد معلومات الفاتورة فقط عندما تستوفي أطراف المعاملة والخدمة وشروط الفوترة المتطلبات؛ ولا يعد ذلك وعدا غير مشروط بإصدارها.',
        integrationTitle: 'خدمات تكامل معلومات برمجية متوافقة',
        integrationDescription: 'يحدد نطاق ربط API وتكامل المعلومات للبرامج وأدوات التطوير وأنظمة الأعمال وفقا للمشروع الفعلي والمتطلبات المطبقة.',
        note: 'تعتمد أهلية إصدار الفاتورة وبنودها والبيانات الضريبية ونطاق الخدمة والتسليم على المعاملة والقواعد المطبقة والاتفاق المتبادل؛ ولا تعني كلمة «متوافق» اعتمادا عاما أو حكما قانونيا لكل قطاع أو استخدام.'
      }
    },
    workflow: {
      eyebrow: 'بدء سريع',
    ...
    notice: {
      ...
      closePermanently: 'عدم الإظهار مجددًا',
