export default {
  ...
  common: {
    ...
    contactAdmin: '联系管理员',
    recharge: '充值',
    rechargeContactHint: '如需充值，请通过以下方式联系管理员：',
    add: '添加',
  ...
  auth: {
    ...
    registrationDisabled: '注册功能暂时关闭，请联系管理员进行注册。',
    emailLabel: '邮箱',
  ...
  admin: {
    ...
    accounts: {
      ...
      oauth: {
        ...
        gemini: {
          ...
          generateAuthUrl: '生成授权链接',
          projectIdLabel: 'Project ID（必填）',
          projectIdPlaceholder: '例如：my-gcp-project 或 cloud-ai-companion-xxxxx',
          projectIdHint:
            'Code Assist 和 Google One OAuth 必须填写。请先创建或选择 Google Cloud 项目，启用 Gemini for Google Cloud API，然后粘贴 Project ID。',
          ...
          missingProjectId:
            'Code Assist / Google One OAuth 必须填写 Project ID。请先创建或选择 Google Cloud 项目，启用 Gemini for Google Cloud API，确认该 Google 账号有访问权限，然后再生成授权链接。',
          ...
          needsProjectId: '内置授权（Code Assist / Google One）',
          needsProjectIdDesc: '必须填写已启用 Gemini for Google Cloud API 的 Project ID',
      ...
      gemini: {
        ...
        oauthType: {
          ...
          googleOneDesc: '个人 Google 账号，也需要填写 Google Cloud Project ID',
          codeAssistDesc: '企业级，需要 Google Cloud Project ID',
        ...
        quotaPolicy: {
          ...
          rows: {
            googleOne: {
              ...
              limitsPlus: '共享池：1200 RPD / 90 RPM（不分模型）',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于 ISACAPI 用户登录',
      ...
      dingtalk: {
        title: '钉钉登录',
        description: '配置钉钉 OAuth，用于 ISACAPI 用户登录',
      ...
      site: {
        ...
        siteSubtitlePlaceholder: 'AI API 服务平台',
        apiBaseUrl: 'API 端点地址',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用 ISACAPI',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">ISACAPI 是一个强大的 AI 服务中转平台，让您轻松管理和分发 AI 服务。</p><p style="margin-bottom: 12px;"><b>🎯 核心功能：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>分组管理</b> - 创建不同的服务套餐（VIP、免费试用等）</li><li>🔗 <b>账号池</b> - 连接多个上游 AI 服务商账号</li><li>🔑 <b>密钥分发</b> - 为用户生成独立的 API Key</li><li>💰 <b>计费管理</b> - 灵活的费率和配额控制</li></ul><p style="color: #10b981; font-weight: 600;">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组是 ISACAPI 的核心概念，它就像一个"服务套餐"：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 示例：</b>您可以创建"VIP专线"（高倍率）和"免费试用"（低倍率）两个分组</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 ISACAPI',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 ISACAPI AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
