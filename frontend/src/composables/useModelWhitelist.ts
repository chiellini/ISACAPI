...
const geminiPresetMappings = [
  ...
  { label: '3 Flash Preview', from: 'gemini-3-flash-preview', to: 'gemini-3-flash-preview', color: 'bg-blue-100 text-blue-700 hover:bg-blue-200 dark:bg-blue-900/30 dark:text-blue-400' },
  { label: '3 Pro Preview', from: 'gemini-3-pro-preview', to: 'gemini-3-pro-preview', color: 'bg-sky-100 text-sky-700 hover:bg-sky-200 dark:bg-sky-900/30 dark:text-sky-400' },
  { label: '3.1 Pro Preview', from: 'gemini-3.1-pro-preview', to: 'gemini-3.1-pro-preview', color: 'bg-violet-100 text-violet-700 hover:bg-violet-200 dark:bg-violet-900/30 dark:text-violet-400' },
  { label: '3.5 Flash', from: 'gemini-3.5-flash', to: 'gemini-3.5-flash', color: 'bg-emerald-100 text-emerald-700 hover:bg-emerald-200 dark:bg-emerald-900/30 dark:text-emerald-400' }
]
...
const antigravityPresetMappings = [
  ...
  { label: '3.8-Flash-High透传', from: 'gemini-3.8-flash-high', to: 'gemini-3.8-flash-high', color: 'bg-emerald-100 text-emerald-700 hover:bg-emerald-200 dark:bg-emerald-900/30 dark:text-emerald-400' },
  { label: '3.8-Flash-Low透传', from: 'gemini-3.8-flash-low', to: 'gemini-3.8-flash-low', color: 'bg-emerald-100 text-emerald-700 hover:bg-emerald-200 dark:bg-emerald-900/30 dark:text-emerald-400' },
  { label: '3.8-Flash-Medium透传', from: 'gemini-3.8-flash-medium', to: 'gemini-3.8-flash-medium', color: 'bg-emerald-100 text-emerald-700 hover:bg-emerald-200 dark:bg-emerald-900/30 dark:text-emerald-400' },
