...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			researchgroup.Table:                 researchgroup.ValidColumn,
			researchgroupmember.Table:           researchgroupmember.ValidColumn,
			researchgroupquotaaudit.Table:       researchgroupquotaaudit.ValidColumn,
