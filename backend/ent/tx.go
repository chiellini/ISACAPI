...
func (tx *Tx) init() {
	...
	tx.ResearchGroup = NewResearchGroupClient(tx.config)
	tx.ResearchGroupMember = NewResearchGroupMemberClient(tx.config)
	tx.ResearchGroupQuotaAudit = NewResearchGroupQuotaAuditClient(tx.config)
