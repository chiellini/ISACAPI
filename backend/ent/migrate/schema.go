	...
	UsageLogsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[10], UsageLogsColumns[44]},
			},
			{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[11], UsageLogsColumns[44]},
			},
			{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[1], UsageLogsColumns[44]},
			},
			{
