...
const (
	...
	// ChatSecurityAuditBody is the original, client-controlled built-in Chat
	// request body. The Chat policy middleware keeps it separate from the body
	// later enriched with trusted system prompts and skills, so moderation and
	// prompt-audit providers never receive server-managed instructions.
	ChatSecurityAuditBody Key = "ctx_chat_security_audit_body"
