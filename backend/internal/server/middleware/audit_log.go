...
var auditSensitiveReads = map[string]string{
	...
	"GET /api/v1/admin/settings/chat-policy":      "admin.chat_policy.read",
...
var auditActionOverrides = map[string]string{
	...
	"PUT /api/v1/admin/settings/chat-policy":                  "admin.chat_policy.update",
...
var auditBodyOmittedRoutes = map[string]struct{}{
	...
	"PUT /api/v1/admin/settings/chat-policy":                    {},
