...
const (
	...
	RoleAdminProvider = domain.RoleAdminProvider
...
const (
	...
	// SettingKeyChatPolicy stores the super-admin managed built-in chat profiles,
	// server-side prompts, and instruction-only skills.
	SettingKeyChatPolicy = "chat_policy"
