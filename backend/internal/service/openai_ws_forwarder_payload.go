...
func (s *OpenAIGatewayService) buildOpenAIWSHeaders(
	...
	// Hermes compatibility is a separate fixed, per-account switch. Apply it
	// after arbitrary header overrides so the toggle has deterministic output;
	// OAuth/Codex accounts are intentionally unaffected.
