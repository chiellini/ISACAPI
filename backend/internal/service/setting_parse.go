...
func (s *SettingService) InitializeDefaultSettings(ctx context.Context) error {
	...
	defaults := map[string]string{
		...
		SettingKeyAntigravityDesktopClientHeaders:                    "false",
...
func (s *SettingService) parseSettings(settings map[string]string) *SystemSettings {
	...
	if v, ok := settings[SettingKeyAntigravityDesktopClientHeaders]; ok && v != "" {
		result.AntigravityDesktopClientHeaders = v == "true"
	} else {
		result.AntigravityDesktopClientHeaders = antigravity.GetDefaultDesktopClientHeadersEnabled()
	}
