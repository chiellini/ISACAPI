...
func TestPrepareUsageLogInsert_ArgCountMatchesTypes(t *testing.T) {
	...
	require.Len(t, prepared.args, 64)
	require.Equal(t, sql.NullInt64{Int64: providerID, Valid: true}, prepared.args[59])
	require.Equal(t, sql.NullInt64{Int64: payerUserID, Valid: true}, prepared.args[60])
	require.Equal(t, sql.NullInt64{Int64: researchGroupID, Valid: true}, prepared.args[61])
	require.Equal(t, sql.NullInt64{Int64: researchGroupMemberID, Valid: true}, prepared.args[62])
	require.Equal(t, sql.NullString{String: fundingSource, Valid: true}, prepared.args[63])
	require.Equal(t, "bigint", usageLogInsertArgTypes[59])
