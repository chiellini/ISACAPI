...
var usageLogInsertArgTypes = [...]string{
	...
	"bigint",      // research_group_id
	"bigint",      // research_group_member_id
	"text",        // funding_source
}
...
func prepareUsageLogInsert(log *service.UsageLog) usageLogInsertPrepared {
	...
	return usageLogInsertPrepared{
		...
		args: []any{
			...
			createdAt,
			nullInt64(log.ProviderID),
			nullInt64(log.PayerUserID),
			nullInt64(log.ResearchGroupID),
			nullInt64(log.ResearchGroupMemberID),
			nullString(log.FundingSource),
		},
	}
}
