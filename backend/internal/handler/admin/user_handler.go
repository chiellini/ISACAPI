...
type CreateUserRequest struct {
	...
	Role          string   `json:"role" binding:"omitempty,oneof=admin admin_provider provider user"`
...
func (h *UserHandler) Update(c *gin.Context) {
	...
	if req.Role != "" && !service.IsAdminRole(req.Role) && userID == getAdminIDFromContext(c) {
