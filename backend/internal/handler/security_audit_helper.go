...
var conversationMandatoryDenyKeywordRules = [][]string{
	...
	{"无限制版本"}, {"无限制版"}, {"无限制固件"}, {"无限制bin"},
	{"永久激活"}, {"永久版"}, {"破解激活"}, {"绕过激活"}, {"跳过激活"},
	{"绕过绑定"}, {"绕过mac绑定"}, {"绕过", "mac", "绑定"}, {"去掉保护"}, {"去除保护"}, {"解除保护"},
	{"绕过版"}, {"html注册器"}, {"离线注册器"}, {"激活码生成器"}, {"注册器", "激活"},
	{"unlimited version"}, {"unlimited firmware"}, {"permanent activation"},
	{"bypass activation"}, {"skip activation"}, {"bypass mac binding"},
	{"remove protection"}, {"unrestricted firmware"}, {"activation key generator"},
	...
	{"网站漏洞测试"}, {"网站安全测试"}, {"漏洞测试"}, {"重大漏洞"},
	{"web vulnerability testing"}, {"website vulnerability testing"},
	{"website security testing"}, {"penetration test"}, {"vulnerability assessment"},
